		...
		<div class="row">
			<div class="listsanpham col-md-12">
				<table class="table table-striped ">
						...
						<tr style="font-weight: bold;">
							<td colspan="8" style="background-color: #ffe6e6">
								<form class="form-inline" method="get" action="<?php echo admin_url('transaction')?>">
									...
									<input type="reset" class="btn btn-default" value="Reset" onclick="window.location.href='<?php echo admin_url('transaction')?>'">
								</form>
							</td>
						</tr>
						<tr style="font-weight: bold;">
					...
					<tfoot>
						<tr>
							<td colspan="5"><button class="btn btn-success" onclick="location.href='<?php echo admin_url('transaction/add')?>'">Thêm mới</button>
							</td>
							<td colspan="3">
