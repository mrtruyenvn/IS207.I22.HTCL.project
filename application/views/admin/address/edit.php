					...
					<div class="main-content">
						...
						<div class="row">
							<div class="col-md-12">	
								...
								<div class="panel-heading"><i class="glyphicon glyphicon-cog"></i> CHỈNH SỬA LIÊN HỆ</div>
								<div class="panel-body">
									...
									<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
										...
										<div class="form-group">
											...
											<div class="col-sm-6">
												<input type="text" class="form-control" name="title" value="<?php echo $addr->title?>">
										...
										<div class="form-group">
											...
											<div class="col-sm-6"> 
												<input type="text" class="form-control" name="phone" value="<?php echo $addr->phone?>">
										...
										<div class="form-group">
											...
											<div class="col-sm-6"> 
												<input type="text" class="form-control" name="address" value="<?php echo $addr->address?>">
										...
										<div class="form-group">
											...
											<div class="col-sm-6"> 
												<textarea rows="5" class="form-control" name="describe" value=""><?php echo $addr->describe?></textarea>
										...
										<div class="form-group"> 
											<div class="col-sm-offset-4 col-sm-6">
												<input type="submit" class="btn btn-success" value="Chỉnh sửa"></input>
											</div>
										</div>
									</form>
								</div>
