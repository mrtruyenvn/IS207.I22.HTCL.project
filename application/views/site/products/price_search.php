              ...
              <div class="panel panel-default product_list">
                <div class="panel-heading"><strong><a href=""><h4><?php if($price_from != $price_to) echo 'Các sản phẩm có giá từ ' .number_format($price_from).' đến '. number_format($price_to); else echo 'Các sản phẩm có giá '.number_format($price_from)?> đ</h4></a></strong></div>
