              ...
              <div class="panel panel-default product_list">
                <div class="panel-heading"><strong><a href="<?php echo base_url('products/top_buy')?>" title="Sản phẩm bán chạy nhất"><h4>Sản phẩm bán chạy nhất</h4></a></strong></div>
                <div class="panel-body">
                  <div class="row">
                  
                     <?php foreach($topbuy as $row):?>
